...
<body>
    ...
    <form action="invoice.php" method="GET" class="row p-2">
        ...
        <table class='table border'>
            ...
            <tr>
                <td>特別獎</td>
                <td><?php if(!empty($num1['number'])){echo sprintf("%08d",$num1['number']);}?></td>
                <td><a href="award.php?aw=1&&year=<?=$year?>&&period=<?=$period?>">對獎</a></td>
            </tr>
            <tr>
                <td>特獎</td>
                <td><?php if(!empty($num2['number'])){echo sprintf("%08d",$num2['number']);}?></td>
            ...
            <tr>
                <td>增開六獎</td>
                <td><?php if(!empty($num4['number'])){echo sprintf("%03d",$num4['number']);}?></td>
