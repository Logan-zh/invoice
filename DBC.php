<?php 
    ...
    function ls($per=1){
        ...
        echo "<div class='col-1 border'>編碼</div>";
        ...
        echo "<div class='col-2 border'>操作</div></div>";
        foreach($rows as $row){
        ...
        echo "<input class='col-1 form-control' name='code' type='text' value='".$row['code']."'>";
        ...
        echo "<a class='dbtn' href='del.php?id=".$row['id']."'>刪除</a>";
        echo "</div>";
        echo "</form>";
    }
        echo "</table>";
